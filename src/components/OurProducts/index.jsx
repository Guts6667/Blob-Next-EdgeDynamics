  ...
  const Sensors = [
    {
      ...
      specs: [
        ...
        "Resolution: 0.5°C",
        "Measuring Length: 1sec to 1min",
        "Customizable upper and lower limit treshold",
      ],
      height: "6.9",
      diameter: "3.9",
      picture: "Edge-H.png",
    },
    {
      ...
      specs: [
        "Accelerator: 0 to 130m/s² (Triaxial)",
        "Velocity: O to 20mm/s (Triaxial)",
        "Measurement frequency band: 10 to 1,00KHz",
        "Resolution: +/-3dB",
        "Measuring Length: 1sec to 1min",
        "Customizable upper and lower limit treshold",
      ],
    ...
    },
    {
      ...
      specs: [
        "Pressure Range: 0 to 3500 psi (250bar)",
  ...
  return (
    <React.Fragment>
      <div className={style.container__ourProducts} id="products">
        ...
        <p className={style.container__product_description}>
          We are <strong>ATEX certify zone</strong> on one of the few in the
          entire industry. We have 16 patents as industrial property and our
          sensors are the most miniaturized in the world.
        </p>
        <div className={style.container__product_content}>
          {Sensors.map((sensor) => {
            return (
              <article
                className={style.box__product}
              ...
              >
                <div className={style.box__product_description}>
                  ...
                  <div className={style.box__product_infos}>
                    <span className={style.type}>{sensor.type}</span>
                    <br />
                    <span>
                ...
                <div className={style.box__product_picture}>
                  ...
                  <span>
                    Height: {sensor.height}cm - Diameter: {sensor.diameter}cm
                  </span>
                </div>
              </article>
            );
